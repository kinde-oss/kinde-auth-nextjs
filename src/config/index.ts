...
const KINDE_SITE_URL = removeTrailingSlash(process.env.KINDE_SITE_URL || process.env.NEXT_PUBLIC_KINDE_SITE_URL);
...
const KINDE_ISSUER_URL = removeTrailingSlash(process.env.KINDE_ISSUER_URL || process.env.NEXT_PUBLIC_KINDE_ISSUER_URL);
const KINDE_CLIENT_ID = process.env.KINDE_CLIENT_ID || process.env.NEXT_PUBLIC_KINDE_CLIENT_ID;
