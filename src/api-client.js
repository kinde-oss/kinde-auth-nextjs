 ...
 * @param {import('next').NextApiRequest} [req] - optional request (required when used with pages router)
 * @param {import('next').NextApiResponse} [res] - optional response (required when used with pages router)
 */
